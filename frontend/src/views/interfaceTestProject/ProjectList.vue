<template>
  <section>
    ...
    <el-table @sort-change='sortChange' :data="project" :row-style="reportRowStyle" :row-class-name="ReportTableRow" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      ...
      <el-table-column prop="lastUpdateTime" label="编辑时间" min-width="22%" sortable='custom'>
      </el-table-column>
      <el-table-column prop="lastUpdatorNickName" label="编辑人" min-width="22%" sortable='custom'>
      </el-table-column>
