<template>
    <section>
        ...
        <el-table @sort-change='sortChange' :data="Case" :row-style="reportRowStyle" :row-class-name="ReportTableRow" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column sortable='custom' prop="lastUpdateTime" label="编辑时间" min-width="30%" show-overflow-tooltip>
            </el-table-column>
            <el-table-column sortable='custom' prop="lastUpdatorNickName" label="编辑人" min-width="20%" show-overflow-tooltip>
            </el-table-column>
            <el-table-column sortable='custom' prop="description" label="描述" min-width="60%" show-overflow-tooltip>
            </el-table-column>
