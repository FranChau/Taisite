<template>
    <section>
        ...
        <el-table @sort-change='sortChange' @selection-change="selsChange" :data="ApiList" :row-style="reportRowStyle" :row-class-name="ReportTableRow" highlight-current-row v-loading="listLoading" style="width: 100%;">
            ...
            <el-table-column prop="requestMethod" label="方法" min-width="20%" sortable='custom'>
              <template slot-scope="scope">
                    <el-tag type="info">{{scope.row.requestMethod}}</el-tag>
                </template>
            </el-table-column>
            <el-table-column prop="route" label="接口地址" min-width="40%" sortable='custom' show-overflow-tooltip>
                <template slot-scope="scope">
