  ...
  <section style="margin: 35px">
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px">
      <el-form :inline="true" :model="filters" @submit.native.prevent>
        ...
        >
          <el-button round style="margin-left: 35px"
            ><i class="el-icon-d-arrow-left"></i> 回首页</el-button
          >
        </router-link>
        <div style="float: right; margin-right: 150px">
          <el-form-item>
            <el-input
              v-model.trim="filters._id"
              placeholder="报告编号"
              @keyup.enter.native="getTestReports"
            ></el-input>
          </el-form-item>
          <el-form-item>
            <el-button
      ...
      <el-table-column label="操作" min-width="23%">
        <template slot-scope="scope">
          <el-button
            ...
            type="primary"
            @click="showReportDetail(scope.$index, scope.row)"
          >
            查看详情</el-button
          >
          <el-button
            ...
            type="primary"
            @click="exportReportDetail(scope.$index, scope.row)"
          >
            导出</el-button
          >
          <el-button
            type="danger"
            size="small"
            @click="singleRemove(scope.$index, scope.row)"
            >删除</el-button
          >
        </template>
      </el-table-column>
    ...
    <el-dialog title="提示" :visible.sync="delVisible" width="300px" center>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="removeRaw">确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog
      ...
      :visible.sync="isReportDetailShow"
    ...
    >
      ...
      >
        <el-table
          height="700"
          :data="testReportDetail"
          :row-class-name="reportsTableRow"
          :header-cell-style="reportHeaderColor"
          v-loading="listLoading"
          style="width: 100%"
        >
          <el-table-column
            prop="testBaseInfo.name"
            label="用例名称"
            min-width="25%"
            sortable
            show-overflow-tooltip
          ...
          <el-table-column
            prop="testBaseInfo.requestMethod"
            label="请求方法"
            min-width="15%"
            sortable
            show-overflow-tooltip
          ...
          <el-table-column
            prop="testBaseInfo.presendParams"
            label="请求参数"
            min-width="15%"
            sortable
            show-overflow-tooltip
          ...
          <el-table-column
            prop="testBaseInfo.checkHttpCode"
            label="状态码校验"
            min-width="18%"
            sortable
            show-overflow-tooltip
          ...
          <el-table-column
            prop="testBaseInfo.checkResponseData"
            label="数据校验"
            min-width="15%"
            sortable
            show-overflow-tooltip
          ...
          <el-table-column
            prop="testBaseInfo.checkResponseNumber"
            label="数值校验"
            min-width="15%"
            sortable
            show-overflow-tooltip
          ...
          <el-table-column
            prop="testBaseInfo.checkResponseSimilarity"
            label="相似度校验"
            min-width="18%"
            sortable
            show-overflow-tooltip
          ...
          <el-table-column
            prop="testBaseInfo.checkResponseTime"
            label="耗时校验/s"
            min-width="17%"
            sortable
            show-overflow-tooltip
...
<script>
    import {getReportList, getReportDetail, exportReportDetail, removeReport} from "../../api/testReport";
        ...
        methods: {
            ...
            batchRemove() {
              ...
              for (let i = 0; i < length; i++) {
                this.delIds.push(this.sels[i]._id)
              }
              this.delVisible = true;
            },
            // 确认删除
            removeRaw(){
              let self = this;
              let header = {};
              removeReport(this.delIds,header).then((res) => {
                let {status, data} = res;
