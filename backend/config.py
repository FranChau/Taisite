...
class Config:
    ...
    _AUTOTEST_PLATFORM_MONGO_HOST = env_dist.get('AUTOTEST_PLATFORM_MONGO_HOST', '192.168.0.217')
    _AUTOTEST_PLATFORM_MONGO_PORT = env_dist.get('AUTOTEST_PLATFORM_MONGO_PORT', '27017')
    _AUTOTEST_PLATFORM_MONGO_USERNAME = env_dist.get('AUTOTEST_PLATFORM_MONGO_USERNAME','admin')
    _AUTOTEST_PLATFORM_MONGO_PASSWORD = env_dist.get('AUTOTEST_PLATFORM_MONGO_PASSWORD','lianan123')
